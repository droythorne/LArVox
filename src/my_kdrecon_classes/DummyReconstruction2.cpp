...
#include "HitInfo.hpp" 
#include "HitMap.hpp"
#include "my_kdrecon_classes/DummyReconstruction2.hpp"
#include "SeedFinder.hpp"
#include "Utility.hpp"

KDRecon::DummyReconstruction2::DummyReconstruction2()
 : currentEvent()
{}
KDRecon::DummyReconstruction2::DummyReconstruction2(const unsigned long nLocalPoints)
	: currentEvent(), currentSegment(nLocalPoints)
{}
void KDRecon::DummyReconstruction2::operator()(KDRecon::EventPtr event)
{
