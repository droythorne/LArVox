...
VOXEL_SRC = $(addprefix src/, voxels/Voxel.cpp voxels/VoxelSetTransforms.cpp voxels/TreeToVoxSet.cpp voxels/VoxSetToTree.cpp voxels/VoxelTree.cpp voxels/VoxelSet3DKDConv.cpp voxels/VoxelNonMaxSupp.cpp) 
